...
cv2.createTrackbar("Hue Max", "Track Bars", 110, 179, empty)
cv2.createTrackbar("Sat Min", "Track Bars", 0, 255, empty)
cv2.createTrackbar("Sat Max", "Track Bars", 168, 255, empty)
cv2.createTrackbar("Val Min", "Track Bars", 59, 255, empty)
